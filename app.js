...
const Puskesmastemplate_path = __dirname + "/template/2025/Puskesmas.xlsx";
const isKec = true;
const DesKectemplate_path = __dirname + (isKec ? "/template/2025/Kec only.xlsx" : "/template/2025/DesaKel only.xlsx");
